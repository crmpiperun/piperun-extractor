...
class Goal:
    id: int | None
    visibility: int | None
    visibility_name: str | None
    type: int | None
    type_name: str | None
    goal_for: int | None
    goal_for_name: str | None
    type_of_period_name: str | None
    item_criteria_name: str | None
    situation_name: str | None
    title: str | None
    observation: str | None
    state: str | None
    type_of_period: int | None
    ...
    def __init__(self, **k):
        ...
        self.visibility_name = {1: 'public', 2: 'private', 3: 'by_participant', None: None}.get(self.visibility)
        self.type = utils.parse_int(k, 'type')
        self.type_name = {1: 'deals', 2: 'activities', 3: 'forecast', 4: 'proposals', 5: 'calls', 6: 'signatures', None: None}.get(self.type)
        self.goal_for = utils.parse_int(k, 'goal_for')
        self.goal_for_name = {1: 'quantity', 2: 'value', 3: 'lead_tme', 4: 'lead_time_in_stage', 5: 'duration', None: None}.get(self.goal_for)
        ...
        self.type_of_period_name = {0: 'custom_period', 1: 'day', 2: 'week', 3: 'two_week', 4: 'month', 5: 'bimester', 6: 'quarter', 7: 'semester',
                                    8: 'year', None: None}.get(self.type_of_period)
        self.item_criteria = utils.parse_int(k, 'item_criteria')
        self.item_criteria_name = {1: 'category', 2: 'item', 3: 'type', None: None}.get(self.item_criteria)
        ...
        self.situation_name = {1: 'active', 2: 'close', 3: 'uninitialized', None: None}.get(self.situation)
